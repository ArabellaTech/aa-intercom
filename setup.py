...
version = get_version("aa_intercom")
...
setup(
    name="aa_intercom",
    version=version,
    url="https://github.com/ArabellaTech/aa-intercom",
    license="MIT",
    description="Django integration for Intercom API",
    long_description=read_file("README.rst"),
    author="Jacek Ostanski",
    author_email="jacek@arabel.la",
    packages=get_packages("aa_intercom"),
    package_data=get_package_data("aa_intercom"),
    zip_safe=False,
